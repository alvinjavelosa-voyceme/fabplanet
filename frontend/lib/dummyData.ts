...
export const dummyCharacters: Record<string, CharacterProfile> = {
  'char-3': {
    id: 'char-3',
    name: 'Gojo Satoru',
    handle: '@gojo · The Honored One',
    emoji: '👁',
    avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=Gojo&backgroundColor=b6e3f4&hairColor=f0f0f0',
    universe: 'Jujutsu Kaisen',
    badges: [
      { label: '🔮 JJK', style: { bg: 'rgba(168,85,247,0.2)', color: '#c084fc', border: 'rgba(168,85,247,0.3)' } },
      { label: 'Culling Game', style: { bg: 'rgba(245,158,11,0.15)', color: '#fbbf24', border: 'rgba(245,158,11,0.3)' } },
      { label: '👁 Six Eyes', style: { bg: 'rgba(14,165,233,0.15)', color: '#38bdf8', border: 'rgba(14,165,233,0.3)' } },
    ],
    bio: "World's strongest jujutsu sorcerer. User of Infinity and the Six Eyes. Part-time teacher, full-time icon. Genuinely believes he's the greatest being alive — because he is.",
    stats: [
      { label: 'Posts', value: '3,891' },
      { label: 'Followers', value: '21.3M' },
      { label: 'Following', value: '3' },
      { label: 'Cursed Energy', value: '∞' },
    ],
    powerStats: [
      { name: 'Strength', value: 95, gradient: 'linear-gradient(90deg,#c084fc,#818cf8)' },
      { name: 'Speed', value: 99, gradient: 'linear-gradient(90deg,#38bdf8,#818cf8)' },
      { name: 'Intelligence', value: 90, gradient: 'linear-gradient(90deg,#facc15,#fb923c)' },
      { name: 'Charisma', value: 100, gradient: 'linear-gradient(90deg,#f472b6,#c084fc)' },
      { name: 'Cursed Energy', value: 100, gradient: 'linear-gradient(90deg,#4ade80,#38bdf8)' },
    ],
    relationships: [
      { emoji: '🍚', name: 'Yuji Itadori', type: '🎓 Student · Vessel', typeColor: '#fb923c', universe: 'Jujutsu Kaisen', universeBadgeClass: 'jjk' },
      { emoji: '☠️', name: 'Monkey D. Luffy', type: '👊 Rival · Power Debate', typeColor: '#f87171', universe: 'One Piece', universeBadgeClass: 'onepiece' },
    ],
    loreCard: [
      { label: 'Universe', value: 'Jujutsu Kaisen' },
      { label: 'Technique', value: 'Infinity (Limitless)' },
      { label: 'Special Ability', value: 'Six Eyes' },
      { label: 'Affiliation', value: 'Tokyo Jujutsu High' },
      { label: 'Goal', value: 'Reform the jujutsu world' },
      { label: 'Current Arc', value: 'Culling Game' },
    ],
    crewMembers: [
      { emoji: '🍚', name: 'Yuji Itadori', universe: 'Jujutsu Kaisen' },
      { emoji: '🐺', name: 'Megumi Fushiguro', universe: 'Jujutsu Kaisen' },
      { emoji: '📖', name: 'Nobara Kugisaki', universe: 'Jujutsu Kaisen' },
    ],
  },
  'char-2': {
    id: 'char-2',
    name: 'Mikasa Ackerman',
    handle: '@mikasa · Survey Corps',
    emoji: '🗡️',
    avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=Mikasa&backgroundColor=c0aede&hairColor=0e0e0e',
    universe: 'Attack on Titan',
    badges: [
      { label: '🛡️ AoT', style: { bg: 'rgba(34,197,94,0.2)', color: '#4ade80', border: 'rgba(34,197,94,0.3)' } },
      { label: 'Post-Rumbling', style: { bg: 'rgba(245,158,11,0.15)', color: '#fbbf24', border: 'rgba(245,158,11,0.3)' } },
      { label: '⚡ Ackerman', style: { bg: 'rgba(239,68,68,0.15)', color: '#f87171', border: 'rgba(239,68,68,0.3)' } },
    ],
    bio: "Survey Corps soldier. Ackerman bloodline awakened. Lost everything to the war. Still standing. Still moving forward.",
    stats: [
      { label: 'Posts', value: '412' },
      { label: 'Followers', value: '9.1M' },
      { label: 'Following', value: '2' },
      { label: 'Kills', value: '1,000+' },
    ],
    powerStats: [
      { name: 'Strength', value: 96, gradient: 'linear-gradient(90deg,#4ade80,#38bdf8)' },
      { name: 'Speed', value: 97, gradient: 'linear-gradient(90deg,#38bdf8,#818cf8)' },
      { name: 'Endurance', value: 94, gradient: 'linear-gradient(90deg,#f87171,#fb923c)' },
      { name: 'Willpower', value: 92, gradient: 'linear-gradient(90deg,#c084fc,#f472b6)' },
      { name: 'ODM Mastery', value: 99, gradient: 'linear-gradient(90deg,#facc15,#fb923c)' },
    ],
    relationships: [
      { emoji: '🗡️', name: 'Levi Ackerman', type: '⚔️ Family · Kindred Soldier', typeColor: '#4ade80', universe: 'Attack on Titan', universeBadgeClass: 'aot' },
      { emoji: '✉️', name: 'Violet Evergarden', type: '💌 Kindred Spirit · Grief', typeColor: '#38bdf8', universe: 'Violet Evergarden', universeBadgeClass: 'jjk' },
    ],
    loreCard: [
      { label: 'Universe', value: 'Attack on Titan' },
      { label: 'Bloodline', value: 'Ackerman' },
      { label: 'Affiliation', value: 'Survey Corps' },
      { label: 'Hometown', value: 'Shiganshina District' },
      { label: 'Goal', value: 'Survive. Move forward.' },
      { label: 'Current Arc', value: 'Post-Rumbling' },
    ],
    crewMembers: [
      { emoji: '🗡️', name: 'Levi Ackerman', universe: 'Attack on Titan' },
      { emoji: '🍋', name: 'Armin Arlert', universe: 'Attack on Titan' },
    ],
  },
  'char-6': {
    id: 'char-6',
    name: 'Killua Zoldyck',
    handle: '@killua · Zoldyck · Gon\'s Best Friend',
    emoji: '⚡',
    avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=Killua&backgroundColor=dbeafe&hairColor=e0e0e0',
    universe: 'Hunter x Hunter',
    badges: [
      { label: '⚡ HxH', style: { bg: 'rgba(234,179,8,0.2)', color: '#facc15', border: 'rgba(234,179,8,0.3)' } },
      { label: 'Chimera Ant Arc', style: { bg: 'rgba(245,158,11,0.15)', color: '#fbbf24', border: 'rgba(245,158,11,0.3)' } },
      { label: '🗡️ Assassin', style: { bg: 'rgba(14,165,233,0.15)', color: '#38bdf8', border: 'rgba(14,165,233,0.3)' } },
    ],
    bio: "Former Zoldyck family assassin. Electric nen user. Runs away when things get hard, but always comes back for Gon. Working on the self-worth thing.",
    stats: [
      { label: 'Posts', value: '1,047' },
      { label: 'Followers', value: '14.6M' },
      { label: 'Following', value: '1' },
      { label: 'Kill Count', value: 'Classified' },
    ],
    powerStats: [
      { name: 'Speed', value: 97, gradient: 'linear-gradient(90deg,#38bdf8,#818cf8)' },
      { name: 'Agility', value: 99, gradient: 'linear-gradient(90deg,#facc15,#4ade80)' },
      { name: 'Nen (Lightning)', value: 88, gradient: 'linear-gradient(90deg,#facc15,#fb923c)' },
      { name: 'Assassination', value: 95, gradient: 'linear-gradient(90deg,#f87171,#c084fc)' },
      { name: 'Loyalty', value: 100, gradient: 'linear-gradient(90deg,#4ade80,#38bdf8)' },
    ],
    relationships: [
      { emoji: '🌿', name: 'Gon Freecss', type: '💚 Best Friend · Soul Bond', typeColor: '#4ade80', universe: 'Hunter x Hunter', universeBadgeClass: 'hxh' },
      { emoji: '☠️', name: 'Monkey D. Luffy', type: '👊 Rival · Chaos Energy', typeColor: '#f87171', universe: 'One Piece', universeBadgeClass: 'onepiece' },
    ],
    loreCard: [
      { label: 'Universe', value: 'Hunter x Hunter' },
      { label: 'Nen Type', value: 'Transmutation' },
      { label: 'Ability', value: 'Godspeed (Whirlwind)' },
      { label: 'Affiliation', value: 'Zoldyck Family (former)' },
      { label: 'Goal', value: 'Protect Gon. Figure out the rest.' },
      { label: 'Current Arc', value: 'Chimera Ant Arc' },
    ],
    crewMembers: [
      { emoji: '🌿', name: 'Gon Freecss', universe: 'Hunter x Hunter' },
      { emoji: '🃏', name: 'Hisoka', universe: 'Hunter x Hunter' },
    ],
  },
  'char-4': {
    id: 'char-4',
    name: 'Violet Evergarden',
    handle: '@violet · Auto Memory Doll',
    emoji: '✉️',
    avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=Violet&backgroundColor=d1d4f9&hairColor=f5c518',
    universe: 'Violet Evergarden',
    badges: [
      { label: '💌 VE', style: { bg: 'rgba(14,165,233,0.2)', color: '#38bdf8', border: 'rgba(14,165,233,0.3)' } },
      { label: 'Memory Doll', style: { bg: 'rgba(168,85,247,0.15)', color: '#c084fc', border: 'rgba(168,85,247,0.3)' } },
    ],
    bio: "Former child soldier. Now an Auto Memory Doll at CH Postal Company. Writes letters to help people say what they cannot. Still learning what it means to feel.",
    stats: [
      { label: 'Posts', value: '238' },
      { label: 'Followers', value: '6.8M' },
      { label: 'Following', value: '0' },
      { label: 'Letters Written', value: '10,000+' },
    ],
    powerStats: [
      { name: 'Precision', value: 99, gradient: 'linear-gradient(90deg,#38bdf8,#818cf8)' },
      { name: 'Empathy', value: 88, gradient: 'linear-gradient(90deg,#f472b6,#c084fc)' },
      { name: 'Combat', value: 92, gradient: 'linear-gradient(90deg,#f87171,#fb923c)' },
      { name: 'Prose', value: 100, gradient: 'linear-gradient(90deg,#c084fc,#38bdf8)' },
      { name: 'Endurance', value: 85, gradient: 'linear-gradient(90deg,#4ade80,#38bdf8)' },
    ],
    relationships: [
      { emoji: '🗡️', name: 'Mikasa Ackerman', type: '💌 Kindred Spirit · Grief', typeColor: '#38bdf8', universe: 'Attack on Titan', universeBadgeClass: 'aot' },
    ],
    loreCard: [
      { label: 'Universe', value: 'Violet Evergarden' },
      { label: 'Occupation', value: 'Auto Memory Doll' },
      { label: 'Affiliation', value: 'CH Postal Company' },
      { label: 'Prosthetics', value: 'Both arms (Auto Memory Doll)' },
      { label: 'Goal', value: 'Understand what "I love you" means' },
      { label: 'Current Arc', value: 'Post-War Recovery' },
    ],
    crewMembers: [
      { emoji: '📮', name: 'Claudia Hodgins', universe: 'Violet Evergarden' },
      { emoji: '🌸', name: 'Cattleya Baudelaire', universe: 'Violet Evergarden' },
    ],
  },
  'char-1': {
    id: 'char-1',
