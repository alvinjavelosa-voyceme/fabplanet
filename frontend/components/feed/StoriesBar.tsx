...
export default function StoriesBar() {
  ...
  return (
    ...
    >
      {chatbots.map((bot, i) => (
        <ProfileHoverCard key={bot.id} characterId={bot.id}>
          <a href={`/character/${bot.id}`} className="flex flex-col items-center gap-1.5 flex-shrink-0 cursor-pointer no-underline">
            <div
